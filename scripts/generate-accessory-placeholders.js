...
for (const [slug, name] of items) {
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="800" height="500" viewBox="0 0 800 500" role="img" aria-label="${name} — Velzon Trade Enterprises">
  <defs>
  ...
  <text x="400" y="310" text-anchor="middle" font-family="sans-serif" font-size="14" fill="#4B5563">Velzon Trade Enterprises · Coimbatore</text>

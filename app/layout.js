...
export const metadata = {
  ...
  title: {
    default:
      "Velzon Trade Enterprise | Roofing Sheets & PUF Panels · Tamil Nadu",
  ...
  openGraph: {
    ...
    title:
      "Velzon Trade Enterprise | Roofing & Fabrication Across Tamil Nadu",
    description:
  ...
  twitter: {
    ...
    title: "Velzon Trade Enterprise · Tamil Nadu",
    description:

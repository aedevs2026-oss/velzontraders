...
export async function getProducts(categorySlug) {
  if (!isSupabaseConfigured()) {
    // #region agent log
    fetch('http://127.0.0.1:7714/ingest/3106773a-0991-4075-8c39-eee11a2f5f22',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'cc7d39'},body:JSON.stringify({sessionId:'cc7d39',runId:'verify1',hypothesisId:'A',location:'queries.js:getProducts',message:'supabase not configured — constant fallback',data:{categorySlug,fallbackCount:PRODUCTS.length},timestamp:Date.now()})}).catch(()=>{});
    // #endregion

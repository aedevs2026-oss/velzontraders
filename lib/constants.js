...
/** Ten-step client → Velzon fabrication journey (home page). */
export const FABRICATION_APPROACH = {
  eyebrow: "Our professional approach",
  title: "How Velzon approaches fabrication",
  summary:
    "From your first enquiry to site-ready delivery — a structured, documented path that keeps thickness, brand, and lead time clear at every stage.",
  intro:
    "Velzon does not manufacture. We source premium branded materials from mills, fabricate to your drawings, and coordinate supply so your site team receives exactly what was specified — across Tamil Nadu.",
  steps: [
    {
      step: 1,
      phase: "Start",
      title: "Enquiry & site brief",
      description:
        "You share project type, site location, drawings or rough measures, and your timeline. Our materials desk captures the scope — warehouse, retail, government, or residential — so the right catalogue and thickness options are opened from the first conversation.",
      detail:
        "Share WhatsApp drawings, PDF site plans, or a simple measure list. We note delivery location across Tamil Nadu to plan logistics early.",
      image_url: "/how-it-works/site.png",
      image_alt: "Client enquiry and project brief with Velzon materials desk",
    },
    {
      step: 2,
      phase: "Specify",
      ...
      description:
        "We match profile, thickness, and mill brand to your build — galvalume roofing sheets, PUF panels, decking, tile profiles, or steel sections. Every option is tied to documented specs, not generic stock.",
      detail:
        "Roofing: 0.35–0.60 mm from JSW, Tata, AMNS India, or Jindal. PUF: 30 mm or 50 mm cores from Metecno, Alfaa, or Mount India.",
      image_url: "/how-it-works/spec.png",
      image_alt: "Roofing sheet material specification for fabrication",
    },
    {
      step: 3,
      phase: "Specify",
      title: "Quotation & scope confirmation",
      description:
        "You receive a clear quotation — material line items, fabrication scope, estimated lead time, and delivery window. No hidden substitutions; any alternate brand or thickness is discussed before we proceed.",
      detail:
        "Government tenders and franchise rollouts get itemised documentation suitable for approval workflows.",
      image_url: "/how-it-works/quati.png",
      image_alt: "Galvalume roofing sheets quoted for supply and fabrication",
    },
    {
      step: 4,
      phase: "Source",
      title: "Mill sourcing & procurement",
      description:
        "Approved materials are procured from premium mills and makers to the confirmed specification. Velzon coordinates inbound stock so fabrication begins only when the right thickness and profile are on hand.",
      detail:
        "We work with established mill brands — not unbranded stock — so every dispatch matches what was quoted.",
      image_url: "/how-it-works/mills-sourcing.png",
      image_alt: "PUF panel stock sourced for fabrication",
    },
    {
      step: 5,
      phase: "Fabricate",
      ...
      description:
        "Sheets, panels, and profiles are staged at our fabrication desk. Cut lists and drawing references are checked against your order before any profiling or cut-to-length work starts.",
      detail:
        "Insulated panels, metal sheets, and accessory packages are grouped by site zone where needed.",
      image_url: "/how-it-works/workshop-prpeartion.png",
      image_alt: "Fabrication panel preparation at Velzon workshop",
    },
    {
      step: 6,
      phase: "Fabricate",
      title: "Cut-to-length & profiling",
      description:
        "Materials are fabricated to your measures — length cuts, profile matching, and panel sizing for roof and wall. This is where trading meets craftsmanship: branded stock shaped to your site, not off-the-shelf guesswork.",
      detail:
        "Warehouse spans, canopy profiles, and wall cladding lengths are cut to drawing — ready for your install crew.",
      image_url: "/how-it-works/cut-profiling.png",
      image_alt: "PUF roof panel cut and profiled to site measures",
    },
    {
      step: 7,
      phase: "Fabricate",
      title: "Accessories coordination",
      description:
        "Flashings, ridge caps, screws, gutters, sealants, and bracing are paired with the main material package so your site does not chase missing pieces mid-install.",
      detail:
        "Apron flashing, ridge caps, PET bolts, and sealants can be bundled in one coordinated dispatch.",
      image_url: "/how-it-works/accessories-coordination.png",
      image_alt: "Roofing accessories coordinated with fabrication package",
    },
    {
      step: 8,
      phase: "Quality",
      ...
      description:
        "Thickness, finish, dimensions, and quantity are verified against the confirmed scope. Panels and sheets are checked before loading — we treat every package as a site-ready handover, not a warehouse transfer.",
      detail:
        "Colour match, panel core thickness, and cut lengths are signed off at the desk before dispatch is scheduled.",
      image_url: "/how-it-works/pre-dispatch.png",
      image_alt: "PUF wall cladding quality check before dispatch",
    },
    {
      step: 9,
      phase: "Deliver",
      ...
      description:
        "Materials are loaded, labelled, and routed to your site across Tamil Nadu — Coimbatore base with statewide supply. You receive dispatch confirmation and can align your site team to the delivery window.",
      detail:
        "Large warehouse packages and multi-drop franchise orders are planned with lead time communicated upfront.",
      image_url: "/how-it-works/dispatch-logistics.png",
      image_alt: "Warehouse roofing package prepared for dispatch",
    },
    {
      step: 10,
      phase: "Complete",
      title: "Site-ready handover",
      description:
        "Your team receives fabrication-ready materials — cut, profiled, and documented to spec. Velzon remains available for follow-up quantities, matching additions, or the next phase of your project.",
      detail:
        "From first enquiry to installed canopy or completed roof — one supplier, one specification trail, Confidence | Growth | Trust.",
      image_url: "/how-it-works/site-ready-handover.png",
      image_alt: "Completed retail canopy — fabrication delivered and installed",
    },
  ],
};
